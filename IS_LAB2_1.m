...
for i = 1:10000 %Tinklo apmokymo pakartojimai
    for i = 1:length(x)
        ...
        delta1_2 = (1 - (tanh(v1_2))^2)*e; %Aktyvavimo funkcijos išvestinė dauginta iš momentinės klaidos
        %4.2 Skaičiuojama klaidos gradientą paslėptojo sluoksnio neuronams
        delta1_1 = y1_1*(1 - y1_1)*delta1_2*w11_2; %Aktyvavimo f-jos išvestinė dauginta iš antrojo sluoksnio delta
